    ...
    return events ? (
        ...
        <div className="date-detail__wrapper">
            ...
            <div className="no-events">
                <p>На данный момент у Вас нет запланированных мероприятий на этот день.</p>
                <p>Вы можете создать одно или несколько мероприятий, чтобы потенциальне слушатели могли откликнуться.</p>
